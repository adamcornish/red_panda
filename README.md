...
## Final Output
For a given cell, once the VCF file in the "to_check" folder has been assessed by GATK-HC, a final VCF file can be generated by concatenating the results from GATK-HC and those VCF files found in "data/good" and "data/homozygous".
